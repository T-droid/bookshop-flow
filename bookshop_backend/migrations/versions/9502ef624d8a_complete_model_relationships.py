...
Revision ID: 9502ef624d8a
Revises: 
Create Date: 2025-08-01 14:54:28.343931
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('tenant', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_tenant_contact_email'), ['contact_email'], unique=False)
        batch_op.create_index(batch_op.f('ix_tenant_contact_phone'), ['contact_phone'], unique=False)
        batch_op.create_index(batch_op.f('ix_tenant_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_tenant_name'), ['name'], unique=False)
        batch_op.create_index(batch_op.f('ix_tenant_updated_at'), ['updated_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('book')
    with op.batch_alter_table('tenant', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_tenant_updated_at'))
        batch_op.drop_index(batch_op.f('ix_tenant_name'))
        batch_op.drop_index(batch_op.f('ix_tenant_created_at'))
        batch_op.drop_index(batch_op.f('ix_tenant_contact_phone'))
        batch_op.drop_index(batch_op.f('ix_tenant_contact_email'))
